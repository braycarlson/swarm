...
pub fn mocha_visuals() -> egui::Visuals {
...
pub fn macchiato_visuals() -> egui::Visuals {
    let mut visuals = egui::Visuals::dark();
...
pub fn frappe_visuals() -> egui::Visuals {
    let mut visuals = egui::Visuals::dark();
...
pub fn latte_visuals() -> egui::Visuals {
