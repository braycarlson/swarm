...
pub fn one_dark_visuals() -> egui::Visuals {
    ...
    let background = egui::Color32::from_rgb(40, 44, 52);
    let background_alternate = egui::Color32::from_rgb(33, 37, 43);
    let panel = egui::Color32::from_rgb(49, 54, 62);
    let selection = egui::Color32::from_rgb(61, 66, 77);
    let foreground = egui::Color32::from_rgb(171, 178, 191);
    ...
    visuals.faint_bg_color = background_alternate;
    visuals.extreme_bg_color = background_alternate;
    visuals.code_bg_color = panel;
    visuals.warn_fg_color = yellow;
    visuals.error_fg_color = red;

    visuals.window_fill = background_alternate;
