...
pub fn tokyo_night_visuals() -> egui::Visuals {
    ...
    let background = egui::Color32::from_rgb(26, 27, 38);
    let background_dark = egui::Color32::from_rgb(22, 22, 30);
    let background_highlight = egui::Color32::from_rgb(41, 46, 66);
    let background_highlight_dark = egui::Color32::from_rgb(32, 36, 52);
    let terminal_black = egui::Color32::from_rgb(65, 72, 104);
    let foreground = egui::Color32::from_rgb(192, 202, 245);
    let _foreground_dark = egui::Color32::from_rgb(169, 177, 214);
    ...
    visuals.widgets.noninteractive.bg_fill = background_highlight;
    visuals.widgets.noninteractive.weak_bg_fill = background_dark;
    ...
    visuals.widgets.inactive.bg_fill = background_highlight;
    ...
    visuals.widgets.hovered.weak_bg_fill = background_highlight;
    ...
    visuals.widgets.open.weak_bg_fill = background_highlight;
    ...
    visuals.faint_bg_color = background_dark;
    visuals.extreme_bg_color = background;
    visuals.code_bg_color = background_highlight;
    visuals.warn_fg_color = yellow;
    visuals.error_fg_color = red;

    visuals.window_fill = background;
    visuals.window_stroke = egui::Stroke::new(1.0, background_highlight);
    ...
    visuals.panel_fill = background_highlight_dark;
...
pub fn tokyo_night_storm_visuals() -> egui::Visuals {
    ...
    let background = egui::Color32::from_rgb(36, 40, 59);
    let background_dark = egui::Color32::from_rgb(31, 35, 53);
    let background_highlight = egui::Color32::from_rgb(56, 62, 90);
    let background_highlight_dark = egui::Color32::from_rgb(44, 49, 70);
    let terminal_black = egui::Color32::from_rgb(68, 75, 106);
    let foreground = egui::Color32::from_rgb(169, 177, 214);
    let comment = egui::Color32::from_rgb(86, 95, 137);
    let blue = egui::Color32::from_rgb(125, 207, 255);
    let cyan = egui::Color32::from_rgb(125, 207, 255);
    let magenta = egui::Color32::from_rgb(187, 154, 247);
...
pub fn tokyo_night_day_visuals() -> egui::Visuals {
    ...
    let background = egui::Color32::from_rgb(230, 237, 243);
    let background_dark = egui::Color32::from_rgb(213, 223, 232);
    let background_highlight = egui::Color32::from_rgb(197, 210, 224);
    let background_highlight_darker = egui::Color32::from_rgb(185, 200, 216);
    let terminal_black = egui::Color32::from_rgb(169, 184, 203);
    let foreground = egui::Color32::from_rgb(52, 59, 88);
    ...
    visuals.panel_fill = background_highlight_darker;
